...
namespace UnityEngine.XR.ARKit
{
    ...
    /// </summary>
    [Preserve]
    public sealed class ARKitReferencePointSubsystem : XRAnchorSubsystem
    {
        ...
        class Provider : IProvider
        {
            ...
            public override unsafe TrackableChanges<XRAnchor> GetChanges(
                XRAnchor defaultReferencePoint,
                Allocator allocator)
            {
            ...
            public override bool TryAddReferencePoint(Pose pose, out XRAnchor referencePoint)
            {
            ...
            static bool UnityARKit_refPoints_tryAdd(Pose pose, out XRAnchor referencePoint)
            {
                referencePoint = default(XRAnchor);
                return false;
            }
